                ...
                <thead>
                    ...
                    <?php while($unit_data = $get_all_unit_data->fetch(PDO::FETCH_ASSOC)){ ?>
                      ...
                      <!-- <td><input type="checkbox" value ="" name="" /> -->
                          ...
                          <td><?php echo $unit_data['code'];?></td>
                          <td><?php echo $unit_data['itemunit'];?></td>
                        
                          <td><?php echo $unit_data['status'];?></td>
                                        
                          <td>
                            <a class="btn btn-outline-success btn-xs" href="updateForm_itemunit.php?objid=<?php echo $unit_data['objid'];?>&id=<?php echo $unit_data['code'];?> "><i class="fa fa-search"></i>
                            </a>
                            &nbsp;                           
