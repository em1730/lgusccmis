...
$get_all_supplier_sql = "SELECT * FROM tbl_suppliers  order by code";
$get_all_supplier_data = $con->prepare($get_all_supplier_sql);
$get_all_supplier_data->execute();
...
$title = "LGUSCC | List Of Suppliers";
?>
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">List of Suppliers
              <a href="add_suppliers.php" id="add_supplier" style="float:right;" type="button" class="btn btn-info bg-gradient-info" style="border-radius: 0px;">
          ...
          <div class="box-body">
            <table id="users" class="table table-bordered table-striped">
              ...
              <tbody>
              <?php while($supplier_data = $get_all_supplier_data->fetch(PDO::FETCH_ASSOC)){?>
                  <tr>
                  <td><?php echo $supplier_data['objid'] ?></td>
                  <td><?php echo $supplier_data['code'] ?></td>
                  <td><?php echo $supplier_data['name_supplier'] ?></td>
                  <td><?php echo $supplier_data['product_lines'] ?></td>
                  <td><?php echo $supplier_data['owner'] ?></td>
                  <td><?php echo $supplier_data['address'] ?></td>
                  <td><?php echo $supplier_data['contact_no'] ?></td>
                  <td>
                        <a class="btn btn-outline-success btn-xs" href="view_supplier.php?id=<?php echo
                                                                                                  $supplier_data['objid']; ?>"><i class="fa fa-check-square-o"></i>
                        </a>
                        <a class="btn btn-outline-success btn-xs" href="view_pdf.php?orno=<?php echo
                                                                                          $jobOrder_data['objid']; ?>"><i class="fa fa-search"></i>
                        </a>
