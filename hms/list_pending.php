...
$get_all_sql = "SELECT * FROM tbl_repair WHERE status = 'Active' AND remarks = 'Pending' ORDER BY idno DESC";
...
<head>
    ...
    <title> HM SYSTEM | List of Pending Repair</title>
                                        ...
                                        <tbody>
                                            <?php while ($repair_data = $get_all_data->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr align="center">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-danger btn-sm" href="view_pending.php?objid=<?php echo $repair_data['objid_no']; ?>&id=<?php echo $repair_data['idno']; ?> ">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
