...
$get_code = $get_categ = $get_status = $type = $get_idno = $get_position='';

if (isset($_GET['objid'])) {
  $user_id = $_GET['id'];

  $get_position_sql = "SELECT * FROM tbl_position WHERE idno = :id";
  $get_position_data = $con->prepare($get_position_sql);
  $get_position_data->execute([':id' => $user_id]);
  while ($result = $get_position_data->fetch(PDO::FETCH_ASSOC)) {
...
<head>
  ...
  <title>BAC SYSTEM | Update Position</title>
            ...
            <?php echo $alert_msg; ?>
              <div class="box-body">
                    ...
                    <div class="row" hidden > 
                      ...
                      <div class="col-md-10">
                          <input type="text" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="idno" placeholder="ID NO" value="<?php echo $get_idno; ?>" required>
                      </div>
                    </div><br>
                    ...
                    <div class="row"> 
                      ...
                      <div class="col-md-10">
                          <input type="text" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="position" placeholder="Position" value="<?php echo $get_position; ?>" required>
                      </div>
                    </div><br>
              ...
              <input type="button"  <?php echo $btnEdit; ?> name="edit" id ="btnEdit" class="btn btn-primary" value="Edit">
                <input type="submit"  <?php echo $btnSave; ?> name="update_position" id="btnSubmit" class="btn btn-primary" value="Update">
                <a href="list_position">
