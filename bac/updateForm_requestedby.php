...
include ('update_requestedby.php');
...
if (isset($_GET['objid'])) {
  ...
  $get_preparedby_sql = "SELECT * FROM tbl_requestedby WHERE idno = :id";
  $get_prepare_data = $con->prepare($get_preparedby_sql);
  $get_prepare_data->execute([':id' => $user_id]);
  while ($result = $get_prepare_data->fetch(PDO::FETCH_ASSOC)) {
...
<head>
  ...
  <title>BAC | Update Requested by</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Update Requested by</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <?php echo $alert_msg; ?>
              ...
              <input type="button"  <?php echo $btnEdit; ?> name="edit" id ="btnEdit" class="btn btn-primary" value="Edit">
                <input type="submit"  <?php echo $btnSave; ?> name="update_requestedby" id="btnSubmit" class="btn btn-primary" value="Update">
                <a href="list_requestedby">
