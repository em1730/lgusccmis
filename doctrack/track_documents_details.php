...
if (isset($_GET['docno'])) {
  ...
  $track_document_sql = "SELECT docno, txndate, time, particulars, receiver, origin, destination, status, remarks,
CONCAT(HOUR(difftime), ' hour(s) ' ,
MINUTE(difftime), ' minute(s) ' ,
SECOND(difftime), ' second(s) ') as processing from (Select docno, txndate, time, particulars, receiver, origin, destination, status, remarks, SEC_TO_TIME(UNIX_TIMESTAMP(end_time) - UNIX_TIMESTAMP(start_time)) as difftime from tbl_ledger l where l.docno = :doc order by txndate DESC, time DESC) 
as temp order by txndate DESC, time DESC";
                  ...
                  <ul class="timeline">
                    ...
                    <li>
                      ...
                      <div class="timeline-item">
                        ...
                        <span class="time"><i class="fa fa-hourglass-half" style="color:red;"><strong> <?php echo $track_data['processing']; ?> </strong></i></span>
