...
<head>
    ...
    <title>HM SYSTEM | Released Repaired Hardware</title>
                        ...
                        <div class="box box-primary">
                            <form role="form" method="post">
                                <div class="box-body">
                                    ...
                                    <input type="text" style="text-align:center; " readonly class="form-control" id="objid" name="objid" value="<?php echo $get_unique; ?>" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" style="text-align:center;" readonly class="form-control" name="get_receivedDate" placeholder="Date" value="<?php echo $get_date; ?>" required>
                                        </div>
                                        <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                                            <label>Time:</label>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="text" style="text-align:center; " readonly class="form-control" name="get_receivedTime" placeholder="Supplier Code" value="<?php echo $get_time; ?>" required>
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <textarea rows="2" class="form-control" name="get_action" id="get_action" placeholder="Action Taken" required><?php echo $get_actionTaken; ?></textarea>
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <textarea rows="2" class="form-control" name="get_recommendation" id="get_recommendation" placeholder="Recommendation" required><?php echo $get_recommend; ?></textarea>
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="box-footer" align="center">
                                        ...
                                        <a style="" target="blank" id="printlink" class="btn btn-dark" href="../plugins/jasperreport/Technical Service Report.php?objidno=<?php echo $get_unique;  ?>">
                                            <i class="nav-icon fa fa-print"></i></a>
                                        <!-- <a href="list_pending ">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#print').click(function() {
                var objidnumber = $('#objid').val();
                console.log(objidnumber);

                $('#printlink').attr("href", "../plugins/jasperreport/Technical Service Report.php?objidno=" + objidnumber, '_parent');
            })
        });
    </script>
