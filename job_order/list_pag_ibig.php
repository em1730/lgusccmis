...
<?php include 'insert_project.php'; ?>
  ...
  <section class="content-header">
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-3">
           <a href="#myModal"  id="myBtn" class="btn btn-primary btn-block mb-3"><i class="icon fa fa-plus"></i> Pag-Ibig Contribution</a>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-header bg-outline bg-info">
              <h4><b>Monthly Contribution</b></h4>
               <span class="close">&times;</span>
           
        </div>
     <form class="form-horizontal" method="POST" action="insert_pag_ibigAll.php">
      <div class="card-body"> 
      <div class="form-group"> 
                      <div class="row">
          <div class="col-lg-12">
...
<input type="text"   name="payrollno" class="form-control">
   ...
   $get_name['year']; ?>"><?php echo  $get_name['year']?></option> <?php } ?>
            ...
            <div class="col-md-4"> 
                   <div class="form-group"> 
                    <label> Amount: </label>
                    <input type="text" id="pagamount" style="text-align: right"<?php echo $month?> name="pagamount" class="form-control">
                  </div>
                    </div>
                    </div>
                </div>
...
<hr>
                    <div class="footer">
                       <a class="btn btn-default btn-l float-left" align="left" href="list_pag_ibig.php" value="Back" ><i class="fa fa-back-arrow"></i> Back</a>
