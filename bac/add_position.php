...
<head>
  ...
  <title>BAC SYSTEM | Add Position</title>
            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row"> 
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="position" placeholder="Position" value="<?php echo $position; ?>" required>
                  </div>
                </div><br>
            ...
            <select class="form-control select2" id="status" style="width: 100%;" name="status" value="<?php echo $status; ?>">
             ...
             <?php } ?>
              ...
              <input type="submit"  <?php echo $btnNew; ?> name="add" class="btn btn-primary" value="New">
                <input type="submit"  <?php echo $btnSave; ?> name="insert_position" class="btn btn-primary" value="Save">
