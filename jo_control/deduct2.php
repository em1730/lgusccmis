...
<?php include 'insert_pag_ibig.php'; ?>
  ...
  <section class="content-header">
    ...
    <div class="col-sm-6">
     ...
     <img class="brand-image img-square "  
                       ...
                       alt="User profile picture" width="50" height="50"> Pag-Ibig
           ...
           <div class="container">
            ...
            <form method="post" action="" enctype="multipart/form-data">   
                ...
                <div class="form-group"> 
                      <div class="row">
          <div class="col-lg-11">
                      <div class="card card-outline card-success" style="background-color: #d8eefe;margin-left:70px">
...
<input type="hidden"  value="<?php echo $get_firstn?>" id="joName" name="name" readonly class="form-control"> 
   ...
   $get_name['year']; ?>"><?php echo  $get_name['year']?></option> <?php } ?>
            ...
            <div class="col-md-2"> 
                   <div class="form-group"> 
                    <label> Amount: </label>
                    <input type="text" id="sssamount" <?php echo $month?> name="pagamount" class="form-control">
                  </div>
                    </div>
                    </div>
                </div>
