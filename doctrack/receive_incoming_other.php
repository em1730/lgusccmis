            ...
            <div class="box-body">
              <form action="">
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" id="doc_no" name="doc_no" placeholder="Document Number" value="<?php echo $docno; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select class="form-control select2" id="select_type" style="width: 100%;" name="type" value="<?php echo   $selected; ?>">
                      <option>Please select...</option>
                      <?php while ($get_type = $get_all_document_data->fetch(PDO::FETCH_ASSOC)) { ?>
                        <?php $selected = ($type == $get_type['objid']) ? 'selected' : '';  ?>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select class="form-control select2" style="width: 100%;" name="origin" id="department" value="<?php echo  $origin; ?>">
                      <option>Please select...</option>
                      <?php while ($get_receiver = $get_all_departments_data->fetch(PDO::FETCH_ASSOC)) { ?>
                        <?php $selected = ($origin == $get_receiver['objid']) ? 'selected' : ''; ?>
                ...
                <div class="col-md-10">
                  <input type="hidden" readonly class="form-control" name="department" placeholder="Department" value="<?php echo $department; ?>">
                </div>
                <div class="col-md-10">
