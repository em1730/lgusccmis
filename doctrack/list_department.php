...
$title = 'LGUSCC | List of Department';
      ...
      <section class="content">
        ...
        <div class="card card-info">
          <div class="card-header">
            ...
            <h4 class="card-title">List of Offices/Departments
              <a href="add_department.php" id="add_individual" style="float:right;" type="button" class="btn btn-info bg-gradient-info" style="border-radius: 0px;">
          ...
          <div class="box-body">
            <table id="users" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <?php while ($department_data = $get_all_department_data->fetch(PDO::FETCH_ASSOC)) { ?>
                  <tr>
                    <td><?php echo $department_data['objid']; ?></td>
                    <td><?php echo $department_data['department']; ?></td>
                    <td><?php echo $department_data['status']; ?></td>
                    <td>
                      <a class="btn btn-outline-success btn-xs" href="view_department.php?id=<?php echo
                                                                                                $department_data['objid']; ?>"><i class="fa fa-check-square-o"></i>
                      </a>
