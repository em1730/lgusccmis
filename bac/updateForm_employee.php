            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" data-provide="datepicker" >
                                                        ...
                                                        <input type="text" readonly class="form-control pull-right" id="datepicker" name="datecreated" placeholder="Date Created" value="<?php echo $datecreated; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div><br>
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" id="idnumber" name="idnumber" placeholder="ID Number" value="<?php echo $get_idnumber; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" id="fname" name="firstname" placeholder="First Name" value="<?php echo $get_firstname; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" id="mname" name="middlename" placeholder="Middle Name" value="<?php echo $get_middlename; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" id="lname" name="lastname" placeholder="Last Name" value="<?php echo $get_lastname; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <textarea rows="2" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" id="address" name="address" placeholder="Employee Address"  required><?php echo $get_address; ?></textarea>
                  </div>
                </div><br>
                    ...
                    <div class="form-group">
                      <div class="input-group date" data-provide="datepicker" >
                        <div class="input-group-addon">
                           ...
                           <input type="text" readonly class="form-control pull-right" id="datepicker" name="birthdate" placeholder="Birth Date" value="<?php echo $get_bdate; ?>">
                      </div>
                    </div>
                  </div>
                </div><br>
                ...
                <div class="col-md-10">
                    <select class="form-control select2" readonly id="section" style="width: 100%;" name="section" value="<?php echo $type; ?>">
                       <option>Please select...</option>
                    <?php while ($get_section_data = $get_all_section_data->fetch(PDO::FETCH_ASSOC)) { ?> -->
                <?php
                    //if $get_author naa value, check nato if equals sa $get_author1['fullname']
                    //if equals, put 'selected' sa option
                    $selected = ($get_section == $get_section_data['section'])? 'selected':'';
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly onkeyup="this.value = this.value.toUpperCase();" class="form-control" id= "contact" name="contact" placeholder="Contact Number" value="<?php echo $get_contact_no; ?>" required>
                  </div>
                </div><br>
              ...
              <input type="button"  <?php echo $btnEdit; ?> id="btnEdit"  class="btn btn-primary" value="Edit">
                <input type="submit"  <?php echo $btnStatus; ?> id="btnSubmit" name="insert_employee" class="btn btn-primary" value="Update">
...
<script>
    ...
    $('#btnEdit').click(function()
    {
      ...
      // $("select[name='itemunit']").removeAttr("readonly");
      // $("#datecreated").readonlyDatepicker(false);

      $("#btnSubmit").attr("disabled", false);
      $("#btnEdit").attr("disabled", true);
      $('#datecreated').datepicker().on('change', function (e) {        
