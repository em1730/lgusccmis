...
if (isset($_GET['objid'])) {
    ...
    $get_sql = "SELECT * FROM tbl_verifiedby WHERE idno = :id";
...
<head>
    ...
    <title> HM SYSTEM | Update Verified By</title>
                            ...
                            <form role="form" method="POST" action="">
                                <div class="box-body">
                                    ...
                                    <div class="box-footer" align="center">
                                        ...
                                        <button type="submit" <?php echo $btnSave; ?> name="update_verifiedby" id="btnSave" class="btn btn-success">
                                            <i class="fa fa-check fa-fw"> </i> </button>
                                        <a href="list_verifiedby">
