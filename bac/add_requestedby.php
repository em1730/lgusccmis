...
include ('insert_requestedby.php');
...
<head>
  ...
  <title>BAC SYSTEM | Add Requested by</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Requested By</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <select class="form-control select2" id="status" style="width: 100%;" name="status" value="<?php echo $status; ?>">
             ...
             <?php } ?>
              ...
              <input type="submit"  <?php echo $btnNew; ?> name="add" class="btn btn-primary" value="New">
                <input type="submit"  <?php echo $btnSave; ?> name="insert_requestedby" class="btn btn-primary" value="Save">
