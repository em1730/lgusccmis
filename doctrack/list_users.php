...
//select all users
$get_all_department_sql = "SELECT user_id, CONCAT (first_name,' ', middle_name,' ', last_name) as FULLNAME, contact_no, position, email,department, username FROM tbl_users";
        ...
        <div class="card card-info">
          ...
          <div class="card-header">
            ...
            <h4 class="card-title">List of Users
              <a href="add_users.php" id="add_individual" style="float:right;" type="button" class="btn btn-info bg-gradient-info" style="border-radius: 0px;">
          ...
          <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF"); ?>">
            <div class="box-body">
              <table id="users" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php while ($users_data = $get_all_department_data->fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                      <td><?php echo $users_data['user_id']; ?></td>
                      <td><?php echo $users_data['FULLNAME']; ?></td>
                      <td><?php echo $users_data['contact_no']; ?></td>
                      <td><?php echo $users_data['position']; ?></td>
                      <td><?php echo $users_data['email']; ?></td> 
                      <td><?php echo $users_data['department']; ?></td>
                      <td>
                        <a class="btn btn-outline-success btn-xs" href="view_users.php?id=<?php echo
                                                                                          $users_data['user_id']; ?>"><i class="fa fa-check-square-o"></i>
                        </a>
                       
                        <!-- <a class="btn btn-outline-success btn-xs" href="view_users.php?id=<?php echo
                                                                                          $users_data['user_id']; ?>"><i class="fa fa-search"></i>
                        </a> -->
                      ...
                      <!-- <td><?php echo $users_data['userpass']; ?></td> -->
                      <!-- <td><?php echo $users_data['account_type']; ?></td>
                   
                    <td><?php echo $users_data['location']; ?></td>
