...
<head>
  ...
  <title>DOCTRACK | Received Document</title>
      ...
      <section class="content">
        <div class="card">
          <div class="card-header bg-success">
            <h4>Received Document</h4>

          </div>
          <div class="card-body">
            <form role="form" method="post" action="insert_forward.php">
              <div class="box-body">
                <?php echo $alert_msg; ?>
                ...
                <div class="box-footer" align="center">
                  ...
                  <button type="submit" <?php echo $btnStatus; ?> name="insert_forward" class="btn btn-success">
                    <h5>Submit</h5>
                  </button>
