...
$objid = $department =  $status  = $fname = $last = $middle = $emp_number = $designation = $emp_type = '';
$btnNew = 'disabled';
$btnStatus = '';
            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="empNumber" placeholder="Type N/A if not applicable!" value="<?php echo $emp_number; ?>">
                  </div>
                </div><br>
                <div class="row">
                  <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" readonly class="form-control" name="emp_type" value="<?php echo $emp_type; ?>">
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <select class="form-control select2" style="width: 100%;" name="designation" value="<?php echo $designation; ?>">
                      <option>Please select...</option>
                      <?php while ($get_code = $get_all_degCode_data->fetch(PDO::FETCH_ASSOC)) { ?>
                        <option> <?php echo $get_code['DesignationCode']; ?></option>
                      <?php } ?>
                    </select>
                  </div>
                </div><br>
