...
<head>
  ...
  <title>BAC SYSTEM | Add Item Unit</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Item Unit</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row"> 
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="code" placeholder="Item Unit Code" value="<?php echo $code; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                   <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="unit" placeholder="Item Unit Name" value="<?php echo $itemunit; ?>" required>
                  </div>
                </div><br>
            ...
            <select class="form-control select2" id="status" style="width: 100%;" name="status" value="<?php echo $status; ?>">
             ...
             <?php } ?>
              ...
              <input type="submit"  <?php echo $btnNew; ?> name="add" class="btn btn-primary" value="New">
                <input type="submit"  <?php echo $btnSave; ?> name="insert_itemunit" class="btn btn-primary" value="Save">
                <a href="index">
