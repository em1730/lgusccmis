...
$get_all_preparedby_sql = "SELECT * FROM tbl_preparedby where status='ACTIVE'";
$get_all_preparedby_data = $con->prepare($get_all_preparedby_sql);
$get_all_preparedby_data->execute();  
...
<head>
  ...
  <title> BAC | List of Prepared by</title>
    ...
    <section class="content">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Prepared by Details</h3>
        </div>
            ...
            <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF");?>">
              <div class="box-body">
                <table id="users" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php while($preparedby_data = $get_all_preparedby_data->fetch(PDO::FETCH_ASSOC)){ ?>
                    <tr>  
                    <!-- <td><input type="checkbox" value ="" name="" /> -->
                        <td><?php echo $preparedby_data['idno'];?></td>
                        <td><?php echo $preparedby_data['firstname'];?> <?php echo " ";?><?php echo $preparedby_data['middlename'];?><?php echo " ";?><?php echo $preparedby_data['lastname'];?></td> 
                        <td><?php echo $preparedby_data['department'];?></td>
                        <td><?php echo $preparedby_data['position'];?></td>
                        <td><?php echo $preparedby_data['status'];?></td>
                                       
                        <td>
                          <a class="btn btn-outline-success btn-xs" href="updateForm_preparedby.php?objid=<?php echo $preparedby_data['objid'];?>&id=<?php echo $preparedby_data['idno'];?> "><i class="fa fa-search"></i>
                          </a>
                          &nbsp;                           
