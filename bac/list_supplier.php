...
$get_all_suppliers_sql = "SELECT * FROM tbl_suppliers where status='ACTIVE'";
$get_all_suppliers_data = $con->prepare($get_all_suppliers_sql);
$get_all_suppliers_data->execute();  
...
<head>
  ...
  <title> BAC | List of Supplier</title>
            ...
            <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF");?>">
              <div class="box-body">
                <table id="users" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php while($suppliers_data = $get_all_suppliers_data->fetch(PDO::FETCH_ASSOC)){ ?>
                    <tr>  
                    <!-- <td><input type="checkbox" value ="" name="" /> -->
                        <td><?php echo $suppliers_data['idno'];?> </td>
                        <td><?php echo $suppliers_data['code'];?> </td>
                        <td><?php echo $suppliers_data['owner'];?> </td>
                        <td><?php echo $suppliers_data['name_supplier'];?> </td>
                        <td><?php echo $suppliers_data['product_lines'];?> </td>
                        <td><?php echo $suppliers_data['address'];?> </td> 
                      
                        <td><?php echo $suppliers_data['status'];?></td>
                                       
                        <td>
                          <a class="btn btn-outline-success btn-xs" href="updateForm_supplier.php?objid=<?php echo $suppliers_data['objid'];?>&id=<?php echo $suppliers_data['idno'];?> "><i class="fa fa-search"></i>
                          </a>
                          &nbsp;                           
