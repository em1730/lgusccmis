            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="code" placeholder="Supplier Code" value="<?php echo
$code; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="name_supplier" placeholder="Name of Supplier" value="<?php echo
$name_supplier; ?>" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="owner" placeholder="Propritor/Owner" value="<?php echo
$owner; ?>" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="product_lines" placeholder="Product Lines" value="<?php echo
$product_lines; ?>" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <textarea rows="2" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="address" placeholder="Business Address"  required><?php echo
$address; ?></textarea>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="contact_no" placeholder="Contact Number" value="<?php echo
$contact_no; ?>">
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="contact_person" placeholder="Contact Person" value="<?php echo
$contact_person; ?>" >
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="fax_no" placeholder="Fax No." value="<?php echo
$fax_no; ?>" >
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <textarea rows="2" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="others" placeholder="Others"  ><?php echo
$others; ?></textarea>
                  </div>
                </div><br>
                <div class="row">
