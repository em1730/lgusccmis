...
if (isset($_GET['objid'])) {
  ...
  $get_preparedby_sql = "SELECT * FROM tbl_preparedby WHERE idno = :id";
...
<head>
  ...
  <title>BAC | Update Prepared by</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="card">
            <div class="card-header">
              <h3 class="card-title">Update Prepared by</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
            ...
            <?php echo $alert_msg; ?>
              ...
              <input type="button"  <?php echo $btnEdit; ?> name="edit" id ="btnEdit" class="btn btn-primary" value="Edit">
                <input type="submit"  <?php echo $btnSave; ?> name="update_preparedby" id="btnSubmit" class="btn btn-primary" value="Update">
                <a href="list_preparedby">
