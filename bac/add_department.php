...
<head>
  ...
  <title>BAC | Add Department</title>
      ...
      <div class="card-body">
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              ...
              <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="code" placeholder="Code" value="<?php echo $code; ?>" required>
                  </div>
              </div><br>
              <div class="row"> 
                  <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-10">
                      <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="department" placeholder="Department" value="<?php echo $dept; ?>" required>
                  </div>
              </div><br>
            ...
            <input type="submit" <?php echo $btnSave; ?> name="insert_department" class="btn btn-primary" value="Save">       
