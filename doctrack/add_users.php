            ...
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="user_id" placeholder="Type N/A if not applicable" value="" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="first_name" placeholder="Firstname" value="" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="middle_name" placeholder="Middlename" value="" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="last_name" placeholder="Lastname" value="" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="number" class="form-control" name="contact_no" placeholder="Contact Number" value="" required>
                  </div><br>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="userpass" placeholder="User Password" value="">
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                    <input type="text" class="form-control" name="account_type" placeholder="Account Type" value="" required>
                  </div>
                </div><br>
                ...
                <div class="row">
                  <div class="col-md-2" style="text-align: right;padding-top: 5`px;">
