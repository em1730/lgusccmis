...
<head>
  ...
  <title>LGUSCC DTS | Force Receive</title>
      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header bg-success">
            <h3 class="card-title">FORCE RECEIVE</h3>
          </div>
          <div class="card-body">
            <form role="form" method="post" action="<?php htmlspecialchars("PHP_SELF"); ?>">
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <select class="form-control select2" id="doc_no" style="width: 100%;" name="doc_no" value="<?php echo $docno; ?>">
                  ...
                  <div class="col-md-3">
                    <input type="text" readonly id="type" class="form-control" name="type" placeholder="Document Type" value="<?php echo $type; ?>">
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input type="text" readonly id="origin" class="form-control" name="origin" placeholder="Originating Office" value="<?php echo $origin; ?>">
                  </div>
                </div><br>
                  ...
                  <div class="col-md-8">
                    <div class="form-group">
                      <div class="input-group date" data-provide="datepicker">
                        ...
                        <input type="text" class="form-control pull-right" id="datenow" name="date" placeholder="Date Created" value="<?php echo $now->format('m/d/Y');; ?>">
                      </div>
                    </div>
                  </div>
                </div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                    <input type="text" required id="remarks" class="form-control" name="remarks" placeholder="Remarks" value="<?php echo $remarks; ?>">
                  </div>
                </div><br>
