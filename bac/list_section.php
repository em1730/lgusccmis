...
<head>
  ...
  <title> BAC | List of Sections</title>
            ...
            <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF");?>">
              <div class="box-body">
                <table id="users" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php while($section_data = $get_all_section_data->fetch(PDO::FETCH_ASSOC)){ ?>
                    <tr>  
                    <!-- <td><input type="checkbox" value ="" name="" /> -->
                        <td><?php echo $section_data['idno'];?> </td>
                        <td><?php echo $section_data['section'];?></td>
                        <td><?php echo $section_data['status'];?></td>
                                       
                        <td>
                          <a class="btn btn-outline-success btn-xs" href="updateForm_section.php?objid=<?php echo $section_data['objid'];?>&id=<?php echo $section_data['idno'];?> "><i class="fa fa-search"></i>
                          </a>
                          &nbsp;                           
