...
$list_doctype = array(
    ...
    array(
        'objid' => 'AFF',
        'type' => 'Affidavit (Loss or Complaint)',
        'description' => 'AFFIDAVIT'
    ),
    array(
        'objid' => 'AIP',
        'type' => 'Annual Investment Program',
    ...
    array(
        'objid' => 'MONELTR',
        'type' => 'Monetization Letter',
        'description' => 'Monetization Letter'
    ),
    ...
    array(
        ...
        'description' => 'Notice of Budget Forum',
        'status' => 'Active'
    ),
    array(
        'objid' => 'NPC',
    ...
    array(
        ...
        'description' => 'Notice to he Public',
        'status' => 'Active'
    ),
    array(
        'objid' => 'NTCPROC',
    ...
    array(
        'objid' => 'NOSAII',
        'type' => 'Notice of Salary Adjustment/Increase/Increment',
        'description' => 'Notice of Salary Adjustment/Increase/Increment',
        'status' => 'Active'
    ),
    array(
        'objid' => 'NTCSI',
