...
$docno = $date  = $type = $particulars = $origin = $destination =  $obr_no = $account = $dv_no = $cheque_no =$acct_no = $amount =$status =$payee=  $remarks = '';
...
//select all payee
$get_all_payee_sql = "SELECT code, name_supplier from tbl_suppliers UNION
select objid, CONCAT(firstname, ' ', middlename, ' ', lastname) from tbl_joborder ORDER BY name_supplier";
...
<?php } ?>
                ...
                <div class="col-md-2" style="text-align: right;padding-top: 5px;">
                  ...
                  <div class="col-md-10">
                      <input type="text" readonly  class="form-control" id="dv_no" name="dv_number"  placeholder="DV Number" value="<?php echo
$dv_no; ?>" required>
                  </div>
                </div><br>
...
$cheque_no; ?>" required>
                ...
                <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control select2" readonly style="width: 100%;" name="payee" value="<?php echo $origin; ?>">
                                                   <option>Please select...</option>
...
$particulars; ?></textarea>
                ...
                <div class="row">
                  ...
                  <div class="col-md-10">
                      <input type="text" class="form-control" id="amount" name="amount"  placeholder="Amount" value="<?php echo
$amount; ?>" required>
                  </div>
                </div><br>
